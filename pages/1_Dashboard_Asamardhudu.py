...
IMAGE_PATH = os.path.join(dir_of_interest, "images", "Asamardhudu.jpg")
DATA_PATH = os.path.join(dir_of_interest, "data", "Asamardhudu.csv")

st.title("Dashboard - Asamardhudu Data")
